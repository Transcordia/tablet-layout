...
load( baseDir + '/jasmine/jasmine-all.js' );
...
function executeTests( testDirs ) {
    ...
    if ( fs.isFile( testDirs ) ) {
//        log.info( 'Loading file', testDirs );
        load( testDirs );
//        log.info( 'Done loading file', testDirs );
    }
...
if ( require.main === module ) {
    ...
    /*
     ...
     domain : 'dev-migrate',
     name : 'com.transcordia.migrate.transfers',
     version : '0.0.0',
